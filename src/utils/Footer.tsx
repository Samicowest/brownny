      ...
      <div className="flex max-w-5xl gap-8 md:gap-2 flex-col-reverse md:flex-row justify-between mx-auto p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="flex-1 p-2">
              ...
              <ul>
                ...
                <li className="list-none py-2 cursor-pointer">Shipping</li>
        ...
        <div className="flex-3 p-2 w-full  md:w-[40%]">
          ...
          <div className="flex">
            ...
            />
            <button className="bg-brown text-white p-2 rounded-r-md">
              Subscribe
            </button>
          </div>
        </div>
